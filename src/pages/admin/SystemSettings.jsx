...
const SystemSettings = () => {
  ...
  const fetchSettings = async () => {
    try {
      ...
      // If API returns empty or invalid data, use mock data instead
      ...
      const fetchedSettings = {
        ...MOCK_SETTINGS, // Start with mock data as defaults
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                You're viewing demo data. Real settings will appear when connected to the server.
              </p>
            </div>
          </div>
        </div>
